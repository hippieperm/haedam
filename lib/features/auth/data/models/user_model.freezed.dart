...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl({
    ...
    this.phone,
    final Map<String, bool> roles = const {},
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, displayName: $displayName, phone: $phone, roles: $roles, createdAt: $createdAt, verified: $verified)';
  }
